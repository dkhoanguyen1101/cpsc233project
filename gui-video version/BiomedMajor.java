...
public class BiomedMajor extends Chara {
	...
	public BiomedMajor(int id) {
        super("Biomedical Major", id, 10, 250, 3, 10, 250, 7, 4, 1, "This special boosts the health \n of a chosen nearby ally \n (costs 3 mana). \n Select the tile of the teammate you would like to heal that is within three tiles", "BioChem.png");
	}
